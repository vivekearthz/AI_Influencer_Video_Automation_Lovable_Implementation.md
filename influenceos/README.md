...
A two-sided, escrow-protected marketplace connecting creators and brands.
Implements [`docs/InfluenceOS-Implementation.md`](../docs/InfluenceOS-Implementation.md).
...
This is intentionally a **separate app** from the AI Influencer Video
Automation product in this repository — different domain, different data
model, different users. Deploy it as its own Lovable/Vite project.
